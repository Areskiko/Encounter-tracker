...
#Creatures
class creature():
    def __init__(self, name = "None", maxHp: int = 1, hp: int = 1, tempHp: int = 0, speed: int = 30, initiative: int = 10, AC: int = 10, stats: dict = {"strength":10, "dexterity":10, "constitutio":10, "intelligence":10, "wisdom":10, "charisma":10}, inventory: list = [], gear: list = [], conditions: list = []):
